...
```{python}
combined_df["ZIP_CD"] = combined_df["ZIP_CD"].astype(int)
merged_tx = zip_codes_tx.merge(combined_df, left_on = "NAME", right_on = "ZIP_CD", how = "left")
...
affected_zip_codes_gdf.crs = "EPSG:4326" 
