...
merged_hospitals["Closure_Year"] = merged_hospitals["Year"]
...
可能要改成这个，你看看
```{python}
final_closed_hospitals_corrected["ZIP_CD"] = final_closed_hospitals_corrected["ZIP_CD"].astype(int)
merged_tx = zip_codes_tx.merge(final_closed_hospitals_corrected, left_on = "NAME", right_on = "ZIP_CD", how = "left")
