...
```{python}
import geopandas as gpd
filepath = r"C:\Users\X1\Desktop\Github\fall2024\problem-set-4-ashley-ruiyi\gz_2010_us_860_00_500k\gz_2010_us_860_00_500k.shp"
data = gpd.read_file(filepath)
```
```{python}
data["centroid"] = data.geometry.centroid
zips_all_centroids = data.set_geometry("centroid")
...
```{python}
result["ZIP_CD_x"] = result["ZIP_CD_x"].astype(int)
merged_tx = zip_codes_tx.merge(result, left_on = "NAME", right_on = "ZIP_CD_x", how = "left")
